...
public sealed class TextToSpeechService : ITextToSpeechService
{
    ...
    public async Task<TextToSpeechResponse> SynthesizeAsync(TextToSpeechRequest request, CancellationToken cancellationToken = default)
    {
        ...
        const string sourceApi = "elevenlabs";
        ...
        var contentHash = BuildElevenLabsContentHash(voiceId, modelId, outputFormat, voiceSettings, text);
        ...
        var audio = await CallElevenLabsAsync(el, voiceId, modelId, text, outputFormat, voiceSettings, cancellationToken);
