...
IConfiguration configuration) : IAuthService
{
    ...
    public async Task<AuthResponse> LoginAsync(LoginRequest loginRequest, CancellationToken cancellationToken = default)
    {
        ...
        if (user != null && passwordHasher.VerifyPassword(loginRequest.Password, user.Password))
        {
            ...
            await mongoDbService.Users.UpdateOneAsync(
                u => u.Id == user.Id,
                update,
    ...
    public async Task<AuthResponse> RefreshTokenAsync(string refreshToken, CancellationToken cancellationToken = default)
    {
        ...
        var user = await mongoDbService.Users.Find(filter).FirstOrDefaultAsync(cancellationToken);
        ...
        var update = Builders<User>.Update
            ...
            .Set(u => u.RefreshTokenExpiryTime, newRefreshTokenExpiry)
            .Set(u => u.UpdatedAt, DateTime.UtcNow);
