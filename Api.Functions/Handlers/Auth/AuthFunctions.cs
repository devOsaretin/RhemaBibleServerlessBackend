  ...
  ILogger<AuthFunctions> logger)
{
  ...
  public Task<HttpResponseData> Login(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse<AuthResponse>.SuccessResponse(response));
  ...
  public Task<HttpResponseData> VerifyEmail(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse.Success(verify));
    }, cancellationToken, logger, env);
  ...
  public Task<HttpResponseData> ResendOtp(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse<bool>.SuccessResponse(result));
    }, cancellationToken, logger, env);
  ...
  public Task<HttpResponseData> ForgotPassword(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse.Success<string>("If the email exists, a password reset code has been sent."));
    }, cancellationToken, logger, env);
  ...
  public Task<HttpResponseData> ResetPassword(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse.Success<string>("Password has been reset successfully."));
    }, cancellationToken, logger, env);
  ...
  public Task<HttpResponseData> ChangePassword(
    ...
    FunctionExecutionHelper.ExecuteAsync(req, async ct =>
    {
      ...
      return req.CreateJsonResponse(HttpStatusCode.OK, ApiResponse.Success<string>("Password has been changed successfully."));
    }, cancellationToken, logger, env);
